 ...
 * @author valer
 */
public class DapurCon {
    private DapurModel model;
    ...
    String durasi = "00m 00s";
       ...
       try (Connection con = Koneksi.getConnection()) {
        ...
        String sqlUpdate = "UPDATE detail_pesanan SET id_status_makanan = ?, durasi_makanan = ? " +
    ...
    public void tampilkandatamakanan(JTable tabel){
        DapurModel model = new DapurModel();
        DefaultTableModel data = model.getDataMakanan();
        tabel.setModel(data);
